...
const jwt__default = /* @__PURE__ */ _interopDefaultLegacy(jwt);
...
function signToken(payload, privateKey, expiresIn = "1 month") {
  return jwt__default.default.sign(_applySchema(payload), privateKey, { algorithm: "RS256", expiresIn });
}
function validateToken(tokenString, publicKey) {
  let decoded, valid;
  try {
    decoded = jwt__default.default.verify(tokenString, publicKey, { algorithms: ["RS256"] });
